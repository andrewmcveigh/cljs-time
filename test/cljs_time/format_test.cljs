...
(deftest unparse-test
  (let [date (from-date #inst "2013-08-29T00:00:00.000-00:00")]
    ...
    (is (= "29/08/2013 00:00:00.000Z" (format/unparse date "dd/MM/yyyy hh:mm:ss.SSSZ")))))

(deftest arithmetic-test
  (is (= (time/plus (format/parse "30/08/2013" "dd/MM/yyyy") (time/months 1))
        (format/parse "30/09/2013" "dd/MM/yyyy")))
  (is (= (time/plus (format/parse "30/08/2013" "dd/MM/yyyy") (time/months 6))
        (format/parse "30/02/2014" "dd/MM/yyyy")))
  (is (= (time/minus (format/parse "30/08/2013" "dd/MM/yyyy") (time/months 8))
        (format/parse "30/12/2012" "dd/MM/yyyy")))
  (is (= (time/minus (format/parse "30/08/2013" "dd/MM/yyyy") (time/months 1))
        (format/parse "30/07/2013" "dd/MM/yyyy")))
  (is (= (time/plus (format/parse "30/08/2013" "dd/MM/yyyy") (time/millis 1))
        (format/parse "30/08/2013 00:00:00.001" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/plus (format/parse "30/08/2013" "dd/MM/yyyy") (time/millis 1000))
        (format/parse "30/08/2013 00:00:01.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/minus (format/parse "30/08/2013" "dd/MM/yyyy") (time/millis 1))
        (format/parse "29/08/2013 23:59:59.999" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/plus (format/parse "30/08/2013" "dd/MM/yyyy") (time/seconds 1))
        (format/parse "30/08/2013 00:00:01.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/plus (format/parse "30/08/2013" "dd/MM/yyyy") (time/seconds 61))
        (format/parse "30/08/2013 00:01:01.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/minus (format/parse "30/08/2013" "dd/MM/yyyy") (time/seconds 1))
        (format/parse "29/08/2013 23:59:59.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/plus (format/parse "30/08/2013" "dd/MM/yyyy") (time/minutes 1))
        (format/parse "30/08/2013 00:01:00.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/minus (format/parse "30/08/2013" "dd/MM/yyyy") (time/minutes 1))
        (format/parse "29/08/2013 23:59:00.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/plus (format/parse "30/08/2013" "dd/MM/yyyy") (time/hours 1))
        (format/parse "30/08/2013 01:00:00.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/minus (format/parse "30/08/2013" "dd/MM/yyyy") (time/hours 1))
        (format/parse "29/08/2013 23:00:00.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/plus (format/parse "31/08/2013" "dd/MM/yyyy") (time/days 1))
        (format/parse "01/09/2013 00:00:00.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/minus (format/parse "01/08/2013" "dd/MM/yyyy") (time/days 1))
        (format/parse "31/07/2013 00:00:00.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/minus (format/parse "30/08/2013" "dd/MM/yyyy") (time/days 1))
        (format/parse "29/08/2013 00:00:00.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/plus (format/parse "31/08/2013" "dd/MM/yyyy") (time/weeks 1))
        (format/parse "07/09/2013 00:00:00.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/minus (format/parse "30/08/2013" "dd/MM/yyyy") (time/weeks 1))
        (format/parse "23/08/2013 00:00:00.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/plus (format/parse "31/08/2013" "dd/MM/yyyy") (time/years 1))
        (format/parse "31/08/2014 00:00:00.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/minus (format/parse "31/08/2013" "dd/MM/yyyy") (time/years 1))
        (format/parse "31/08/2012 00:00:00.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/plus (format/parse "29/02/2012" "dd/MM/yyyy") (time/years 1))
        (format/parse "28/02/2013 00:00:00.000" "dd/MM/yyyy hh:mm:ss.SSS")))
  (is (= (time/minus (format/parse "29/02/2012" "dd/MM/yyyy") (time/years 1))
