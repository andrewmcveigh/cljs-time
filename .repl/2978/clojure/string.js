...
{var pred__7320 = cljs.core._EQ_;var expr__7321 = limit;if(pred__7320.call(null,1,expr__7321))
{return cljs.core.vector.call(null,s);
} else
{if(pred__7320.call(null,2,expr__7321))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__7323 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__7324 = (limit__$1 - 1);
var G__7325 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__7323;
limit__$1 = G__7324;
parts = G__7325;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___7327 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___7327))
{var replacement_7328 = temp__4090__auto___7327;buffer.append([cljs.core.str(replacement_7328)].join(''));
} else
{buffer.append(ch);
}
{
