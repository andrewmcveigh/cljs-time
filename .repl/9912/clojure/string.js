...
{var pred__9768 = cljs.core._EQ_;var expr__9769 = limit;if(pred__9768.call(null,1,expr__9769))
{return cljs.core.vector.call(null,s);
} else
{if(pred__9768.call(null,2,expr__9769))
{return cljs.core.vector.call(null,"",s);
} else
...
{var ch = s.charAt(index);var temp__4090__auto___9775 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___9775))
{var replacement_9776 = temp__4090__auto___9775;buffer.append([cljs.core.str(replacement_9776)].join(''));
} else
{buffer.append(ch);
}
{
