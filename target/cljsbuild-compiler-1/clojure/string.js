...
{var pred__9159 = cljs.core._EQ_;var expr__9160 = limit;if(pred__9159.call(null,1,expr__9160))
...
{var ch = s.charAt(index);var temp__4090__auto___9166 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___9166))
{var replacement_9167 = temp__4090__auto___9166;buffer.append([cljs.core.str(replacement_9167)].join(''));
} else
{buffer.append(ch);
}
{
