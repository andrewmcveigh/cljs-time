...
{{
var G__6419 = cljs.core.pop.call(null,v__$1);
v__$1 = G__6419;
continue;
}
} else
...
{var pred__6423 = cljs.core._EQ_;var expr__6424 = limit;if(pred__6423.call(null,1,expr__6424))
{return cljs.core.vector.call(null,s);
} else
{if(pred__6423.call(null,2,expr__6424))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__6426 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__6427 = (limit__$1 - 1);
var G__6428 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__6426;
limit__$1 = G__6427;
parts = G__6428;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___6430 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___6430))
{var replacement_6431 = temp__4090__auto___6430;buffer.append([cljs.core.str(replacement_6431)].join(''));
} else
{buffer.append(ch);
}
{
